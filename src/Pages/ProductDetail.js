                    ...
                    <section class="text-gray-700 body-font overflow-hidden bg-white">
                        <div class="container px-5 py-24 mx-auto">
                            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                                <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={sigleProduct.image[0]} />
                        ...
                        <div class=" w-4/5 p-6 bg-gray-100 border border-gray-300 rounded-lg shadow mb-10 mx-auto">
...

                            {
                                sigleProduct.applications.map((application, ind) => (
                                    ...
                                    <ul>
                                        <li className=" mb-3 text-lg ">{application}</li>
                                    </ul>
                                ))
                            }
