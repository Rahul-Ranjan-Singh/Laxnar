        ...
        <>
            <div className='bg-blue-400 text-white'>
                <div className='text-center text-2xl p-3'>
                    <p className=' font-bold'>Do you have any question about our product and services, please don't ask?</p>
                    <p>
                ...
                <div className='text-center px-16'>
                    <div className=' border-b p-8'>
                        ...
                        <p>You can subscribe with your e-mail address in order to get to know news about our company.</p>
                    </div>

                    <div className=' p-8'>
                        <label for='input-group-1' class='block mb-2 text-sm font-medium  dark:text-white'>
                            Your Email
                        </label>
