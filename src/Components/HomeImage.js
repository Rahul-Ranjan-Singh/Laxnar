        ...
        <div className='px-12 border-t border-gray-500 py-12 font-sans bg-white flex-col md:flex-row inline-flex justify-around'>
            ...
            <div className=' relative  p-3 rounded-3xl'>
                ...
                <p className='mb-5 text-justify'>
                    We are Lucknow based elevator control panel manufacture and whole electrical kit supplier. Successfully delivering elevator
                    control panels in north India since 2017. Our UPS is our product quality with solution support. We tend to keep our products easy
                    to install and provide higher safety measures in our products. Providing important technical feature like password protected, easy
                    handling, compact size panels, pre-installed parameters, safety measures, on call service, at site service (if required).
                </p>
                <NavLink to='/about'>
