...
const ProductCard = ({ product }) => {
  return (
    <div className="max-w-sm p-6  border  rounded-lg shadow bg-gray-900 border-gray-700 hover:shadow-lg">
      ...
      <div className="px-3 py-3 font-bold flex justify-center items-center text-white">
        {product.name}
      </div>
