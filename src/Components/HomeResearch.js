                    ...
                    <a class='shadow-2xl flex flex-col items-center border rounded-lg shadow md:flex-row w-2/3 max-sm:w-72 border-gray-700  bg-gray-900 '>
                        ...
                        <div class='flex flex-col justify-between p-4 leading-normal'>
                            ...
                            <p class='mb-3 font-normal text-gray-700 dark:text-gray-400'>
                                Laxnar is focused on accomplishing perfect results with its expertise and vast technical knowledge. Therefore, all
                                Laxnar products are developed by expert Indian engineers and produced in Laxnar facilities. Laxnar does not compromise
                                on quality during the production phase and prefers the finest quality starting right from the designing phase.
                            </p>
                        </div>
                    </a>
                </div>
